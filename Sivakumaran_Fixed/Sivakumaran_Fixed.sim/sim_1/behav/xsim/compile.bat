...
REM
REM Generated by Vivado on Tue May 12 11:49:18 +0530 2026
...
echo "xvhdl --incr --relax -prj RCA_4_tb_vhdl.prj"
call xvhdl  --incr --relax -prj RCA_4_tb_vhdl.prj -log xvhdl.log
